    ...
    return (
        <div className="flex flex-col items-end w-full">
            ...
            <div className="flex flex-col items-end transition-all duration-500 w-full gap-1">
                <p className="font-bold font-financial leading-none tracking-tight transition-all duration-500 text-lg xl:text-xl 2xl:text-2xl whitespace-nowrap truncate max-w-full" style={{ color: labelColor }}>
                    {runwayText}
                </p>
